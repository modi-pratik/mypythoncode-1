...
# root_url = 'http://metricsmonk.com'
# index_url = root_url + '/rankings/custom?type=APP&dimension=MAU&category=all&gender=&age=&country=&date='
...
def show_video_stats(options=None):
